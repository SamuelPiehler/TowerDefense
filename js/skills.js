...
const skills = [
  //BasicTurm
  ["BasicTurm Dmg", "Erhöht den Damage von BasicTürmen um 5%", 0, 2, 0.5, false, [], 0, 10, 0, 1],   //0
  ["BasicTurm Attackspeed", "Reduziert die Angriffszeit von BasicTürmen um 5%", 0, 5, -2, true, [0], 5, 5, 0, 3],    //1
  ...
  ,   //9
  //Sniper
  ["Sniper Dmg", "Erhöht den Damage von Sniper um 5%", 1, 2, 2, true, [], 0, 10, 0, 1],   //10
  ["Sniper Attackspeed", "Reduziert die Angriffszeit von Sniper um 5%", 1, 5, -2, true, [10], 5, 5, 0, 3],    //11
  ["Sniper Reichweite", "Erhöht die Reichweite von Sniper um 7,5%", 1, 4, 3, true, [], 0, 10, 0, 1],    //12
  ["Sniper drehGeschw", "Erhöht die drehGeschwindigkeit von Sniper um 7,5%", 1, 3, 3, true, [], 0, 10, 0, 1],    //13
  ["Sniper critChance", "Erhöht die critChance von Sniper um 5%", 1, 13, 2, false, [10], 1, 20, 0, 1],    //14
  ...
  ,   //19
  //SlowTurm
  ["SlowTurm Dmg", "Erhöht den Damage von SlowTürmen um 5", 2, 2, 0.5, false, [], 0, 10, 0, 1],   //20
  ["SlowTurm Attackspeed", "Reduziert die Angriffszeit von SlowTürmen um 5%", 2, 5, -2, true, [], 0, 5, 0, 1],   //21
  ["SlowTurm Reichweite", "Erhöht die Reichweite von SlowTürmen um 7,5%", 2, 4, 3, true, [], 0, 10, 0, 1],   //22
  ,   //23
  ["SlowTurm critChance", "Erhöht die critChance von SlowTürmen um 5%", 2, 13, 2, false, [20], 5, 20, 0, 1],   //24
  ["SlowTurm critDamage", "Erhöht den CritSchaden von SlowTürmen um 10%", 2, 14, 10, false, [24], 5, 10, 0, 1],    //25
  ["SlowTurm EffecktStärke", "Erhöht die SlowStärke von SlowTürmen um 5%", 2, 8, 2, true, [], 0, 10, 0, 1],    //26
  ...
  ,   //29
  //GiftTurm
  ["GiftTurm Dmg", "Erhöht den Damage von GiftTürmen um 5", 3, 2, 0.5, false, [], 0, 10, 0, 1],   //30
  ...
  ,   //39
  //FeuerAoeTurm
  ["FeuerAoeTurm Dmg", "Erhöht den Damage von FeuerAoeTürmen um 5", 4, 2, 2, true, [], 0, 10, 0, 1],   //40
  ...
  ,   //49
  //AntiBoss
  ["AntiBossTurm Dmg", "Erhöht den Damage von AntiBossTürmen um 5%", 5, 2, 2, true, [], 0, 10, 0, 1],   //50
  ["AntiBossTurm Attackspeed", "Reduziert die Angriffszeit von AntiBossTürmen um 5%", 5, 5, -2, true, [50], 5, 5, 0, 4],    //51
  ["AntiBossTurm Reichweite", "Erhöht die Reichweite von AntiBossTürmen um 7,5%", 5, 4, 3, true, [], 0, 10, 0, 1],    //52
  ["AntiBossTurm drehGeschw", "Erhöht die drehGeschwindigkeit von AntiBossTürmen um 7,5%", 5, 3, 3, true, [], 0, 10, 0, 1],    //53
  ["AntiBossTurm critChance", "Erhöht die critChance von AntiBossTürmen um 5%", 5, 13, 2, false, [50], 1, 20, 0, 1],    //54
  ["AntiBossTurm critDamage", "Erhöht den CritSchaden von AntiBossTürmen um 10%", 5, 14, 10, false, [54], 5, 10, 0, 1],   //55
  ,   //56
  ["AntiBossTurm EffecktDauer", "Erhöht die StunnDauer von AntiBossTürmen um 5%", 5, 9, 2, true, [], 0, 10, 0, 1],    //57
  ...
  ,   //59
  //Rocket
  ["RocketLauncher Dmg", "Erhöht den Damage von RocketLaunchern um 5%", 6, 2, 2, true, [], 0, 10, 0, 1],   //60
  ["RocketLauncher Attackspeed", "Reduziert die Angriffszeit von RocketLaunchern um 5%", 6, 5, -2, true, [60], 5, 5, 0, 3],    //61
  ["RocketLauncher Reichweite", "Erhöht die Reichweite von RocketLaunchern um 7,5%", 6, 4, 3, true, [], 0, 10, 0, 1],    //62
  ["RocketLauncher drehGeschw", "Erhöht die drehGeschwindigkeit von RocketLaunchern um 7,5%", 6, 3, 3, true, [], 0, 10, 0, 1],    //63
  ["RocketLauncher critChance", "Erhöht die critChance von RocketLaunchern um 5%", 6, 13, 2, false, [60], 1, 20, 0, 1],    //64
  ["RocketLauncher critDamage", "Erhöht den CritSchaden von RocketLaunchern um 10%", 6, 14, 10, false, [64], 5, 10, 0, 1],   //65
  ["RocketLauncher EffecktStärke", "Erhöht den AoeSchaden von RocketLaunchern um 5%", 6, 8, 2, true, [], 0, 10, 0, 1],    //66
  ["RocketLauncher EffecktReichweite", "Erhöht die AoEReichweite von RocketLaunchern um 5%", 6, 9, 3, true, [], 0, 10, 0, 1],    //67
  ...
  ,   //69
  //SingleGift
  ["SingleGiftTurm Dmg", "Erhöht den Damage von SingleGiftTürmen um 5%", 7, 2, 2, true, [], 0, 10, 0, 1],   //70
  ["SingleGiftTurm Attackspeed", "Reduziert die Angriffszeit von SingleGiftTürmen um 5%", 7, 5, -2, true, [70], 5, 5, 0, 2],    //71
  ["SingleGiftTurm Reichweite", "Erhöht die Reichweite von SingleGiftTürmen um 7,5%", 7, 4, 3, true, [], 0, 10, 0, 1],    //72
  ["SingleGiftTurm drehGeschw", "Erhöht die drehGeschwindigkeit von SingleGiftTürmen um 7,5%", 7, 3, 3, true, [], 0, 10, 0, 1],    //73
  ["SingleGiftTurm critChance", "Erhöht die critChance von SingleGiftTürmen um 5%", 7, 13, 2, false, [70], 1, 20, 0, 1],    //74
  ["SingleGiftTurm critDamage", "Erhöht den CritSchaden von SingleGiftTürmen um 10%", 7, 14, 10, false, [74], 5, 10, 0, 1],   //75
  ["SingleGiftTurm EffecktStärke", "Erhöht den GiftSchaden von SingleGiftTürmen um 5%", 7, 8, 2, true, [], 0, 10, 0, 1],    //76
  ["SingleGiftTurm EffecktReichweite", "Erhöht die GiftDauer von SingleGiftTürmen um 5%", 7, 9, 3, true, [], 0, 10, 0, 1],    //77
  ["SingleGiftTurm St5", "Stufe 5 SingleGiftTürme bekommen stark verbesserte Stats", 7, 12, true, 0, [123], 2, 1, 0, 5],   //78
  ,   //79
  //LavaTurm
  ["LavaTurm Dmg", "Erhöht den Damage von LavaTürmen um 5%", 8, 2, 1, true, [], 0, 10, 0, 1],   //80
  ...
  ["SupportTurm EffecktStärke", "Erhöht den DmgSupport von SupportTürmen um 5%", 9, 8, 2, true, [], 0, 10, 0, 1, 0],    //90
  ["SupportTurm EffecktReichweite", "Erhöht die DmgSupportReichweite von SupportTürmen um 5%", 9, 9, 3, true, [], 0, 10, 0, 1, 0],    //91
  ["SupportTurm EffecktStärke", "Erhöht den AttackspeedSupport von SupportTürmen um 5%", 9, 8, 2, true, [], 0, 10, 0, 1, 1],    //92
  ["SupportTurm EffecktReichweite", "Erhöht die AttackspeedSupportReichweite von SupportTürmen um 5%", 9, 9, 3, true, [], 0, 10, 0, 1, 1],    //93
  ["SupportTurm EffecktStärke", "Erhöht den EffecktSupport von SupportTürmen um 5%", 9, 8, 2, true, [], 0, 10, 0, 1, 2],    //94
  ["SupportTurm EffecktReichweite", "Erhöht die EffecktSupportReichweite von SupportTürmen um 5%", 9, 9, 3, true, [], 0, 10, 0, 1, 2],    //95
  ["SupportTurm EffecktStärke", "Erhöht den ReichweitenSupport von SupportTürmen um 5%", 9, 8, 2, true, [], 0, 10, 0, 1, 3],    //96
  ["SupportTurm EffecktReichweite", "Erhöht die ReichweitenSupportReichweite von SupportTürmen um 5%", 9, 9, 3, true, [], 0, 10, 0, 1, 3],    //97
  ["SupportTurm St5", "Stufe 5 SupportTürme bekommen stark verbesserte Stats", 9, 12, true, 0, [123], 2, 1, 0, 5],   //98
  ,   //99
  //TeslaTurm
  ["TeslaTurm Dmg", "Erhöht den Damage von TeslaTürmen um 5%", 10, 2, 2, true, [], 0, 10, 0, 1],   //100
  ["TeslaTurm Attackspeed", "Reduziert die Angriffszeit von TeslaTürmen um 5%", 10, 5, -2, true, [100], 5, 5, 0, 3],    //101
  ["TeslaTurm Reichweite", "Erhöht die Reichweite von TeslaTürmen um 7,5%", 10, 4, 3, true, [], 0, 10, 0, 1],    //102
  ["TeslaTurm drehGeschw", "Erhöht die drehGeschwindigkeit von TeslaTürmen um 7,5%", 10, 3, 3, true, [], 0, 10, 0, 1],    //103
  ["TeslaTurm critChance", "Erhöht die critChance von TeslaTürmen um 5%", 10, 13, 2, false, [100], 1, 20, 0, 1],    //104
  ...
  ["TeslaTurm EffecktReichweite", "Erhöht die EffecktReichweite von TeslaTürmen um 5%", 10, 9, 3, true, [100], 3, 10, 0, 1],    //107
  ...
  ["Turm Dmg", "Erhöht den Damage von Türmen um 5%", -1, 2, 2, true, [0, 10, 20, 30, 40, 50, 60, 70, 80, 100], 30, 5, 0, 2],   //110
  ["Turm Attackspeed", "Reduziert die Angriffszeit von Türmen um 5%", -1, 5, -2, true, [1, 11, 21, 31, 41, 51, 61, 71, 81, 101], 20, 3, 0, 5],    //111
  ["Turm Reichweite", "Erhöht die Reichweite von Türmen um 7,5%", -1, 4, 3, true, [2, 12, 22, 32, 42, 52, 62, 72, 82, 102], 30, 5, 0, 2],    //112
  ["Turm drehGeschw", "Erhöht die drehGeschwindigkeit von Türmen um 7,5%", -1, 3, 3, true, [3, 13, 53, 63, 73, 83, 103], 15, 5, 0, 2],    //113
  ["Turm critChance", "Erhöht die critChance von Türmen um 5%", -1, 13, 2, false, [4, 14, 24, 34, 44, 54, 64, 74, 84, 104], 1, 10, 0, 2],    //114
